...
@click.option(
    ...
    default=0.0,
    show_default=True,
    help="X1 coordinate of first physical zone",
)
@click.option(
    "-x2min",
    "--x2min",
    default=0.0,
    show_default=True,
    help="X2 coordinate of first physical zone",
)
@click.option(
    "-x3min",
    "--x3min",
    default=0.0,
    show_default=True,
    help="X3 coordinate of first physical zone",
)
@click.option(
    "-x1max",
    "--x1max",
    default=1.0,
    show_default=True,
    help="X1 coordinate of last physical zone",
)
@click.option(
    "-x2max",
    "--x2max",
    default=1.0,
    show_default=True,
    help="X2 coordinate of last physical zone",
)
@click.option(
    "-x3max",
    "--x3max",
    default=1.0,
    show_default=True,
    help="X3 coordinate of last physical zone",
)
@click.option(
    "-out",
    "--fname",
    default=os.path.join(os.environ.get("PWD"), "grid.h5"),
    show_default=True,
    help="Output file name, enter absolute path",
)
def make_grid(
