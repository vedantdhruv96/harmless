...
def small_cartesian_grid():
    ...
    return Grid('cartesian', 4, 4, 4, a=0., r_out=100.,
...
def small_eks_grid():
    ...
    """
    return Grid('eks', 8, 4, 4, a=0.9375, r_out=1000.,
                x1min=0., x2min=0., x3min=0.,
                x1max=1., x2max=1., x3max=1.)
...
def small_mks_grid():
    ...
    return Grid('mks', 8, 4, 4, a=0.9375, r_out=1000.,
                x1min=0., x2min=0., x3min=0.,
                x1max=1., x2max=1., x3max=1.)
...
def small_fmks_grid():
    ...
    return Grid('fmks', 8, 4, 4, a=0.9375, r_out=1000.,
                x1min=0., x2min=0., x3min=0.,
                x1max=1., x2max=1., x3max=1.)
